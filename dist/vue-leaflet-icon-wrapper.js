(function (global, factory) {
  ...
  (global = global || self, factory(global['vue-leaflet-icon-wrapper'] = {}));
   ...
   */
  var Arrive = (function(window, $, undefined$1) {
  ...
  var script = {
    ...
    methods: {
      instantiate(selector, vm) {
        ...
        return new Component({ ...exists.$options,
          el: selector
        });
      }
  ...
  var __vue_render__ = function() {
    ...
    return _c(
      _vm.component,
      {
        ref: _vm.componentClassRef,
        tag: "component",
        class: _vm.componentClassRef
      },
      [_vm._t("default")],
      2
    )
  ...
  const plugin = {
    install(Vue, options = {
      ...
      Vue.component(options.componentName, __vue_component__);
    }
...
//# sourceMappingURL=vue-leaflet-icon-wrapper.js.map
